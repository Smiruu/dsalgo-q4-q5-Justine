...
function OrderScreen() {
  ...
  const addPayPalScript = () => {
    ...
    script.src =
      "https://www.paypal.com/sdk/js?client-id=AW7niskBCj5KCXtwXKz2P_cJzsR5XSsvY6mdsqwlEu3WsgJM43n8IVk-flZEsXL7pdB8kdL14ph6CDBk&currency=USD";
    script.async = true;
    script.onload = () => {
      setSdkReady(true);
    };
                    ...
                    <ListGroup.Item>
                      ...
                      {!sdkReady ? (
                        ...
                        <PayPalScriptProvider
                          options={{
                            "client-id":
                              "AW7niskBCj5KCXtwXKz2P_cJzsR5XSsvY6mdsqwlEu3WsgJM43n8IVk-flZEsXL7pdB8kdL14ph6CDBk",
                          }}
                        >
                          <PayPalButtons
